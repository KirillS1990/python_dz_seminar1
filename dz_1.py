...
# if a > 7 or a < 1:
#     print('Ввведен неверный день недели')
# elif 8 > a > 5:
#     print('Ввведеный день является выходным')
# else:
#     print('Ввведеный день является будним')
...
#                 if a[i] == 0:
#                     is_OK = False
#                     print("Вы ввели начало оси координат")
#             except ValueError:
...
# if quarter_number > 4:
#     print('Введена не существующая четверть')
# elif quarter_number == 1:
#     print('В этой четверти X от 0 до бесконечности, Y от 0 до бесконечности')
# elif quarter_number == 2:
#     print('В этой четверти X от 0 до бесконечности, Y от 0 до минус бесконечности')
# elif quarter_number == 3:
#     print('В этой четверти X от 0 до минус бесконечности, Y от 0 до минус бесконечности')
# else:
#     print('В этой четверти X от 0 до минус бесконечности, Y от 0 до бесконечности')
...
# def calculatedLengthSegment(a, b):
...
# print(f"Длина отрезка: {format(calculatedLengthSegment(pointA, pointB), '.2f')}")
